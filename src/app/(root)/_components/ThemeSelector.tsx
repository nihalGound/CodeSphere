...
import Github from "../_constants/Github";
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="lg:w-48 w-full  group relative flex items-center gap-2 px-4 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] rounded-lg transition-all duration-200 border border-gray-800/50 max-md:border-gray-600 hover:border-gray-700"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 w-full min-w-[240px] bg-[#1e1e2e]/100 
